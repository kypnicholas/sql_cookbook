...
-- Deliverables: country filter, numeric filter, case-insensitive text search.
-- Verification: Query returns German customers, invoices with total threshold, and tracks containing love.
-- Basic Queries.
